...
class VendorChatScrn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Provider.of<VendorConnectionService>(context, listen: false).showList =
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Consumer<VendorConnectionService>(
              builder: (context, value, child) => value.sortedVendors!.isEmpty
                  ? Center(
                      child: Text(
                      'Chat List Not Found!',
                      style: normalText,
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return value.showList!.isNotEmpty
                            ? ListTile(
                                onTap: () async {
                                ...
                                leading: value.showList![index].profilePhoto ==
                                        null
                                    ? const CircleAvatar(
                                        radius: 28,
                                ...
                                trailing: CircleAvatar(
                                  child: IconButton(
                                      onPressed: () {
                                        if (value.showList![index].phone.toString().isNotEmpty) {
