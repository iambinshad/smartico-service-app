          ...
          Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      Consumer<VendorProvider>(
                        ...
                        return Padding(
                          ...
                          child: Container(
                            height: 60,
                            decoration: BoxDecoration(
                                border: Border.all(color: const  Color.fromARGB(255, 123, 230, 219)),
                      ...
                      kHeight15,
                      context.watch<VendorProvider>().isLoadingsignup?const CircularProgressIndicator(): ElevatedButton(
                        onPressed: () {
           ...
           const Row(
                ...
                children: [
                  ...
                  Text(' Tell us more',style: TextStyle(color:Color.fromARGB(255, 121, 216, 206) ),)
                ],
              )
        ]),
      ),
