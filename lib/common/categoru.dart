  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      body:Consumer<RecentServicesProvider>(
        ...
        Padding(
          padding: const EdgeInsets.only(right: 14,left: 14,bottom: 5,top: 5),
          child: Card(
            elevation: 3.0,
            child: Container(
                width:width/1.1,
                    ...
                    Column(
                      children: [
                        Container(
                          height: height/5,
                          width:width/2.9,
                          decoration: BoxDecoration(color: Colors.blue,image:DecorationImage(image: NetworkImage(value.allGigs![index].image),fit: BoxFit.cover),borderRadius: BorderRadius.only(topLeft: Radius.circular(10),bottomLeft: Radius.circular(10))),
                        )
                      ],
                    ),
                    Column(
