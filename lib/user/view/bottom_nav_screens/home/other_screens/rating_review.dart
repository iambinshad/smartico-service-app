  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'Ratings & Reviews',
            style: normalText.copyWith(fontSize: 26, color: Colors.white),
          ),
        ),
        body: Consumer<ReservedGigs>(
          builder: (context, value, child) => value.reveiws!.isEmpty
              ? const Center(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            kWidth10,
                            Text(value.reveiws![index]!.title,
                                style: normalText),
                          ],
                        ),
                        kHeight10,
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                                'Verified User ${value.reveiws![index]!.date.day}-${value.reveiws![index]!.date.month}-${value.reveiws![index]!.date.year}  ${value.reveiws![index]!.date.hour}:${value.reveiws![index]!.date.minute}:${value.reveiws![index]!.date.second}')
                          ],
                        ),
                      ],
                    ),
